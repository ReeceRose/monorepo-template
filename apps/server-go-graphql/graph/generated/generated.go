...
type ComplexityRoot struct {
	Mutation struct {
		CreateTodo func(childComplexity int, input model.InsertTodo) int
...
type MutationResolver interface {
	CreateTodo(ctx context.Context, input model.InsertTodo) (*model.Todo, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createTodo":
		...
		return e.complexity.Mutation.CreateTodo(childComplexity, args["input"].(model.InsertTodo)), true
...
func (ec *executionContext) _Mutation_createTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().CreateTodo(rctx, args["input"].(model.InsertTodo))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputInsertTodo(ctx context.Context, obj interface{}) (model.InsertTodo, error) {
	var it model.InsertTodo
...
func (ec *executionContext) _Todo(ctx context.Context, sel ast.SelectionSet, obj *model.Todo) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "completed":
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Todo_completed(ctx, field, obj)
			}
